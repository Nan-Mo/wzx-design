...
function CustomRangePicker({
  ...
  const [innerValue, setInnerValue] = React.useState(() => (controlled ? restProps.value : defaultValue));
  ...
  const [dates, setDates] = React.useState<RangePickerProps<Moment>['value']>(null);
