...
export const DATE_SELECT_OPTIONS: DATE_SELECT_OPTION[] = [
  ...
  },
  {
    ...
    DateRender: ({ defaultValue, disabledDate, rangeLimit, endMoment, onChange }) => {
      const [value, setValue] = useState(() => defaultValue || [endMoment, endMoment]);
...
export const getDataRanges = (endMoment: Moment) => {
  return [
    ...
    },
    {
      ...
      label: '上周',
      time: [
        endMoment.clone().subtract(7, 'days').endOf('week').clone().startOf('week'),
    ...
    },
    {
      ...
      label: '上月',
      time: [
        endMoment.clone().startOf('month').subtract(1, 'days').clone().startOf('month'),
