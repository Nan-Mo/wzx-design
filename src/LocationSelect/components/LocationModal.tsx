...
import { Map, Marker, FullLngLatPos } from 'react-amap';
...
const LocationModal = ({ closeModal, visible, initValue }: LocationModalProps) => {
  const geocoder = React.useRef<any>();
  const { province = '', city = '', district = '', address = '' } = initValue?.data || {};
    ...
    >
      ...
      <Row justify="space-between">
        ...
        <Button
          ...
          onClick={() => {
            closeModal();
            center && initValue?.onSuccess!(center, addressObj);
          }}
        >
          确定经纬度
        </Button>
