...
import { ExportButton } from 'wzx-design';
...
const App: React.FC = () => {
  ...
  return (
    <Layout>
      ...
      <Layout>
        <Header style={{ padding: 0, background: '#ffffff', display: 'flex', justifyContent: 'end' }} >
          <ExportPageEntery 
        ...
        <Footer style={{ textAlign: 'center' }}>Tastien Design ©2023 Created by Tastien</Footer>
      </Layout>
    </Layout>
  );
};
